"""
Django settings for delta_dental_member_46805 project.
...
ROOT_URLCONF = 'delta_dental_member_46805.urls'
...
WSGI_APPLICATION = 'delta_dental_member_46805.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delta_dental_member_46805 API",
    "DESCRIPTION": "API documentation for delta_dental_member_46805 App",
    "VERSION": "v1",
}
